angular.module('CapabilitiesManager').service('serviceCapabilitiesManager',
	...
	this.init = function(nameAvatar) {
		...
		this.getCapabilitiesAppliance(nameAvatar);
	};

	// Get the list of capabilities from the appliance and stock it in the capability manager
	this.getCapabilitiesAppliance = function(nameAvatar){
        var self = this;
        serviceApplianceCommunicationManager.loadCimaObject()
        				.$promise.then(function(result){
							self.capabilitiesManager.addCapabilityProvider(nameAvatar, serviceApplianceCommunicationManager.getCapabilities());
