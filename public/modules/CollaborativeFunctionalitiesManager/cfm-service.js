angular.module('CollaborativeFunctionalitiesManager').service('serviceCollaborativeFunctionalitiesManager',
    ...
    this.init = function(nameAvatar) {
        ...
        this.getExposableFunctionalities(nameAvatar);
        this.exposeFunctionalities(collaborativeFunctionalitiesManager.getExposableFunctionalities());
	};
    ...
    this.getExposableFunctionalities = function(nameAvatar){
    ...
    this.exposeFunctionalities = function(exposableFunctionalities){
        console.log("INFO: 1.5.5 - Expose the functionalities to the HTTP Server");
        console.log(collaborativeFunctionalitiesManager.getExposableFunctionalities());
        $http.post('/expose-functionalities/', exposableFunctionalities).
